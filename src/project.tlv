   ...
   |cpu
      ...
      @1
         ...
         */
         ...
         //I_type except loads and treating all loads as same
         $is_load = $opcode == 7'b000_0011;
      ...
      @3
         ...
         //register file RF_write
         $rf_wr_en = >>2$valid_load ? 1'b1 : $valid && (($rd == 5'b0) ? 0 : $rd_valid);
         ...
         // $ld_data[31:0] = >>1$dmem_rd_data[31:0]; ---- this is wrong
