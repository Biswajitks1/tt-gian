...
\SV
   ...
   ///m4_define(['m4_uart_repo'], ['['https://raw.githubusercontent.com/DohJaeger/tt_makerchip_lib/61c73703a450719aa1e52127bc7b6119d2d097d1/']'])
   ///m4_define(['m4_uart_rtl'], ['m4_uart_repo['src/uart_rtl/']'])
                                  
   //including the source files
   ///m4_sv_get_url(m4_uart_rtl['uart_rx.sv'])
   ///m4_sv_get_url(m4_uart_rtl['uart_tx.sv'])
...
\TLV my_design()
   ...
   $digit[3:0] = $trig ? $rx_byte[3:0] : >>1$rx_byte[3:0] ;
...
module top(input logic clk, input logic reset, input logic [31:0] cyc_cnt, output logic passed, output logic failed);
   ...
   /*
   initial begin
      #20  // Drive inputs on the B-phase.
         ui_in = 8'h0;
